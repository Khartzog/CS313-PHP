...
<div class="container">
  ...
  <div class="d-flex align-items-stretch bg-light" style="height:250px">
    <div><img src="HarryPotter.jpg" class="img-rounded" alt="Harry Potter" width="150" height="240"></div>
  ...
  <div class="d-flex align-items-stretch bg-light" style="height:250px">
    <div><img src="HungerGames.jpg" class="img-rounded" alt="Hunger Games" width="150" height="240"></div>
  ...
  <div class="d-flex align-items-stretch bg-light" style="height:250px">
    <div><img src="TheFaultinourStars.jpg" class="img-rounded" alt="The Fault in our Stars" width="150" height="240"></div>
  ...
  <div class="d-flex align-items-stretch bg-light" style="height:250px">
    <div><img src="LordoftheRings.jpg" class="img-rounded" alt="Lord of the Rings" width="150" height="240"></div>
  ...
  <div class="d-flex align-items-stretch bg-light" style="height:250px">
    <div><img src="PercyJackson.jpg" class="img-rounded" alt="Percy Jackson" width="150" height="240"></div>
